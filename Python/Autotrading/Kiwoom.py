...
class Kiwoom(QAxWidget):
    ...
    def _opt10081(self, rqname, trcode):
        ...
        for i in range(data_cnt):
            ...
            open = self._get_comm_data(trcode,  rqname, i, "거래량")
            high = self._get_comm_data(trcode,  rqname, i, "시가")
            low = self._get_comm_data(trcode,  rqname, i, "고가")
            close = self._get_comm_data(trcode,  rqname, i, "저가")
            volume = self._get_comm_data(trcode,  rqname, i, "현재가")
    ...
    def _opw00001(self, rqname, trcode):
        self._temp_var = self._get_comm_data(trcode, rqname, 0, "d+2추정예수금")
        self.d2_deposit = Kiwoom.change_format(self._temp_var)
