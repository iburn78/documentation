...
class MyWindow(QMainWindow, form_class):
    ...
    def check_balance(self):
        ...
        self.kiwoom.comm_rq_data("opw00018_req", "opw00018", 0, "1001")

        while self.kiwoom.remained_data:
            time.sleep(0.2)
            self.kiwoom.set_input_value("계좌번호", account_number)
            self.kiwoom.comm_rq_data("opw00018_req", "opw00018", 2, "1001")

        # opw00001
        self.kiwoom.set_input_value("계좌번호", account_number)
        self.kiwoom.comm_rq_data("opw00001_req", "opw00001", 0, "1002")
